    ...
    for index, record in enumerate(records):
        try:
            ...
            if "age" not in record:
                raise KeyError("Missing key: age")
            if "score" not in record:
                raise KeyError("Missing key: score")
            ...
            error_log.append(
                (index, e.__class__.__name__, str(e))
            )
...
data = [
    ...
    {"name": "Bob", "age": "twenty", "score": "75"},
    {"name": "Charlie", "score": "90"},
    ["Not", "a", "dict"],
    {"name": "David", "age": "19", "score": "92.3"}
]

clean_records, error_log = process_records(data)
